...
const WORKFLOWS_DEFAULT = [
    ...
    {
        id: 'purity-ministry',
        title: 'Men\'s Purity Ministry — Spotswood Baptist',
        category: 'Ministry',
        icon: '🛡️',
        status: 'active',
        currentStep: 0,
        steps: [
            { name: 'Confirm launch date with Dan Cook', desc: 'Reply to Pastor Dan Cook (Spotswood Baptist) with proposed start date for 12-week Wednesday night study. Use freedom@spotswood.org.' },
            { name: 'Send announcement email to men', desc: 'Draft and send announcement email via freedom@spotswood.org. Include: what the group is, when/where, how to sign up. Point to purity-intake.html.' },
            { name: 'Build Noble Warriors resource page', desc: 'Create usmcmin.org/purity — house the 12-week curriculum, 6 survey links, 5 podcast episodes, 10+ blog articles, 20+ resource links. Reference Noble Warriors framework (noblewarriors.org/sexual-integrity) as partner resource. ORLANDO task.' },
            { name: 'Build 12-week curriculum pages', desc: 'One HTML page per week (week-1.html through week-12.html) under /purity/. Each page: week title, key Scripture, teaching outline, discussion questions, homework/action step, prayer. ORLANDO task.' },
            { name: 'Build purity blog series', desc: 'Write 10 blog articles: pornography stats in the church, biblical sexual integrity, accountability frameworks, recovery stories, parent guides. Post to usmcmin.org/blog. AI-assisted but Moop-reviewed.' },
            { name: 'Set up accountability intake', desc: 'Purity intake form (purity-intake.html) connected to email. Men fill out → Moop gets notified → schedule 1-on-1.' },
            { name: 'First group session', desc: 'Host Week 1 at Spotswood Baptist. Welcome, ground rules, introduce P.U.R.E. H.E.A.R.T.S. framework, personal assessment.' },
            { name: 'Run full 12-week curriculum', desc: 'Weekly Wednesday sessions. Track attendance, follow up with absent men, document testimonies.' },
            { name: 'Evaluate and expand', desc: 'Post-cohort review. Gather testimonies. Decide: run again at Spotswood, expand to other churches, publish curriculum as product.' },
        ]
    },
    {
        id: 'disney-trip-2',
