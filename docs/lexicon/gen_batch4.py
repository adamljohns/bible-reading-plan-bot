...
WORDS = [
    ...
    ("G5207","Greek","New Testament","υἱός","huios","Noun, masculine","son, descendant, heir",
     "Son in both biological and covenantal senses. Jesus is preeminently the Son of God — a relational title expressing unique divine relationship and messianic identity. Believers are 'sons of God' through adoption.",
     "The title 'Son of God' in the NT is primarily relational and covenantal, not merely biological. Hebrews 1 argues the Son's superiority to angels; John 1 identifies him as the eternal Son. Adoption (huiothesia) makes believers huioi.",
     [("Matthew 3:17","This is my beloved <em>Son</em> [huios], with whom I am well pleased."),
      ...
      ("Romans 8:14","For all who are led by the Spirit of God are <em>sons</em> [huios