"""MBT 1 Corinthians — 16 chapters, 437 verses. Book ID 46."""
import json, pathlib
...
ch1 = {
    ...
    10: "Now I urge you, brothers, by the name of our Lord Jesus Christ — that you all agree, and that there be no divisions among you, but that you be made complete in the same mind and in the same judgment.",
...
ch2 = {
    1: "And when I came to you, brothers, I did not come with superiority of speech or of wisdom, proclaiming to you the testimony of God.",
...
ch3 = {
    1: "And I, brothers, could not speak to you as to spiritual men — but as to men of flesh, as to infants in Christ.",
    2: "I gave you milk to drink, not solid food — for you were not yet able to receive it. Indeed, even now you are not yet able.",
    3: "For you are still fleshly. For where there is jealousy and strife among you, are you not fleshly — and are you not walking like mere men?",
    ...
    18: "Let no man deceive himself. If any man among you thinks that he is wise in this age, let him become foolish, so that he may become wise.",
...
ch4 = {
    ...
    5: "Therefore do not go on passing judgment before the time — but wait until the Lord comes, who will both bring to light the things hidden in the darkness, and disclose the motives of men's hearts. Then each man's praise will come to him from God.",
    6: "Now these things, brothers, I have figuratively applied to myself and Apollos for your sakes — so that in us you may learn not to exceed what is written, in order that no one of you will become arrogant in behalf of one against the other.",
    ...
    17: "For this reason I have sent to you Timothy — who is my beloved and faithful child in the Lord. He will remind you of my ways which are in Christ — just as I teach everywhere in every church.",
...
ch5 = {
    1: "It is actually reported that there is sexual immorality among you — and immorality of such a kind as does not exist even among the Gentiles, that someone has his father's wife.",
    2: "And you have become arrogant — and have not mourned instead, so that the one who had done this deed would be removed from your midst.",
    ...
    10: "I did not at all mean with the sexually immoral people of this world — or with the covetous and swindlers, or with idolaters. For then you would have to go out of the world.",
    11: "But actually, I wrote to you not to associate with any so-called brother, if he is sexually immoral, or covetous, or an idolater, or a slanderer, or a drunkard, or a swindler — not even to eat with such a one.",
...
ch6 = {
    ...
    8: "On the contrary, you yourselves wrong and defraud — and even your brothers!",
    9: "Or do you not know that the unrighteous will not inherit the kingdom of God? Do not be deceived. Neither the sexually immoral, nor idolaters, nor adulterers, nor effeminate, nor those who practice homosexuality,",
    ...
    18: "Flee sexual immorality. Every other sin that a man commits is outside the body — but the immoral man sins against his own body.",
...
ch7 = {
    ...
    34: "And his interests are divided. The woman who is unmarried, and the virgin, is concerned about the things of the Lord — that she may be holy both in body and in spirit. But one who is married is concerned about the things of the world — how she may please her husband.",
...
ch8 = {
    ...
    6: "yet for us there is but one God, the Father — from whom are all things, and we exist for Him; and one Lord, Jesus Christ — through whom are all things, and we exist through Him.",
    ...
    12: "And so, by sinning against the brothers and wounding their conscience when it is weak, you sin against Christ.",
...
ch9 = {
    ...
    21: "To those who are without the Law, as without the Law (though not being without the Law of God, but under the law of Christ) — so that I might win those who are without the Law.",
...
ch10 = {
    ...
    9: "Nor let us put the Lord to the test, as some of them did, and were destroyed by the serpents.",
...
ch11 = {
    ...
    16: "But if anyone seems to be contentious — we have no other practice, nor have the churches of God.",
...
ch13 = {
    ...
    4: "Love is patient. Love is kind. Love is not jealous. Love does not brag, and is not arrogant.",
    5: "Love does not act unbecomingly; it does not seek its own; it is not provoked; it does not take into account a wrong suffered.",
...
ch14 = {
    ...
    20: "Brothers, do not be children in your thinking. Yet in evil be infants — but in your thinking be mature.",
    ...
    26: "What is the outcome then, brothers? When you assemble — each one has a psalm, has a teaching, has a revelation, has a tongue, has an interpretation. Let all things be done for edification.",
    ...
    39: "Therefore, my brothers, desire earnestly to prophesy — and do not forbid to speak in tongues.",
    40: "But all things must be done properly and in an orderly manner.",
}
ch15 = {
    1: "Now I make known to you, brothers, the gospel which I preached to you — which also you received, in which also you stand,",
    ...
    23: "But each in his own order — Christ the firstfruits, after that those who are Christ's at His coming.",
    ...
    39: "All flesh is not the same flesh — but there is one flesh of men, another flesh of beasts, another flesh of birds, and another of fish.",
    ...
    50: "Now I say this, brothers — that flesh and blood cannot inherit the kingdom of God. Nor does the perishable inherit the imperishable.",
    ...
    58: "Therefore, my beloved brothers, be steadfast, immovable, always abounding in the work of the Lord — knowing that your toil is not in vain in the Lord.",
}
ch16 = {
    ...
    12: "But concerning Apollos our brother, I encouraged him greatly to come to you with the brothers — and it was not at all his desire to come now, but he will come when he has opportunity.",
    13: "Be on the alert. Stand firm in the faith. Act like men. Be strong.",
    14: "Let all that you do be done in love.",
    15: "Now I urge you, brothers — you know the household of Stephanas, that they were the firstfruits of Achaia, and that they have devoted themselves for ministry to the saints.",
    16: "That you also be in subjection to such men, and to everyone who helps in the work and labors.",
    17: "And I rejoice over the coming of Stephanas, Fortunatus, and Achaicus — because they have supplied what was lacking on your part.",
    ...
    22: "If anyone does not love the Lord, let him be accursed. Maranatha — \"O Lord, come!\"",
...
def main():
    new_entries = {f"46_{ch}_{v}": text for ch, verses in CHAPTERS.items() for v, text in verses.items()}
    print(f"1 Corinthians total verses authored: {len(new_entries)}")
    ...
    print(f"moop-translation.json: merged {len(new_entries)} MBT 1 Cor verses")
