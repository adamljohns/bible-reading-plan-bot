"""MBT generator: Esther (complete book, 10 chapters, 167 verses).

Book ID 17. NKJV-faithful skeleton, modern English flow.
Persian setting; God's name famously never appears, but His
providence runs through every chapter. MBT preserves this restraint —
no inserted "God" where the Hebrew has none — while the reader feels
the unseen Hand throughout.
"""
...
ch1 = {
    1: "Now it came to pass in the days of Ahasuerus (this was the Ahasuerus who reigned over a hundred and twenty-seven provinces, from India to Ethiopia),",
    2: "that in those days, when King Ahasuerus sat on the throne of his kingdom, which was in Shushan the citadel,",
    3: "in the third year of his reign he made a feast for all his officials and servants — the powers of Persia and Media, the nobles, and the princes of the provinces being before him —",
...
ch3 = {
    ...
    4: "Now it happened, when they spoke to him daily and he would not listen to them, that they told Haman, to see whether Mordecai's words would stand; for Mordecai had told them that he was a Jew.",
...
ch6 = {
    1: "That night the king could not sleep. So he ordered the book of the records of the chronicles to be brought, and they were read before the king.",
...
ch8 = {
    ...
    8: "You yourselves write a decree for the Jews, as you please, in the king's name, and seal it with the king's signet ring; for whatever is written in the king's name and sealed with the king's signet ring no one can revoke.\"",
    ...
    13: "A copy of the decree was to be issued as law in every province, being published for all people, so that the Jews would be ready on that day to take vengeance on their enemies.",
...
ch10 = {
    ...
    3: "For Mordecai the Jew was second to King Ahasuerus, and was great among the Jews and well received by the multitude of his brethren, seeking the good of his people and speaking peace to all his kindred.",
}

CHAPTERS = {1: ch1, 2: ch2, 3: ch3, 4: ch4, 5: ch5, 6: ch6, 7: ch7, 8: ch8, 9: ch9, 10: ch10}
...
def main():
    ...
    for ch, verses in CHAPTERS.items():
        for v, text in verses.items():
            new_entries[f"17_{ch}_{v}"] = text
    data.update(new_entries)
    MOOP_PATH.write_text(json.dumps(data, ensure_ascii=False, indent=2) + "\n")
    print(f"Esther verses authored: {len(new_entries)}")
