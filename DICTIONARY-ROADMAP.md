...
> **Next up:** Continue toward 7,777 (2,729 entries to go). The baby-names directory at 838 displayed names
> (226 primary + 612 variants) with search and popularity stars. Possible next batches: more OT kings
> (Jehoshaphat, Joash, Amaziah, Ahaz), Christian-tradition dict entries (Augustine, Calvin, Knox, Wesley already
> exist; could add Theresa, Cecilia, Perpetua), more covenant doctrine, more biblical institutions.
