...
> **Next up:** Continue toward 7,777 (2,729 entries to go). The baby-names directory at 144 of Adam's
> requested ~200 goal — another ~60 names need authoring (mostly remaining minor prophets, kings, NT women).
> Possible next batches: more OT kings (Jehoshaphat, Joash, Amaziah, Ahaz), more covenant doctrine, more
