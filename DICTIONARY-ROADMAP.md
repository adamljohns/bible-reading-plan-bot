...
> **Next up:** Continue toward 7,777 (2,749 entries to go). Possible next batches: more covenant doctrine,
> Hebrews-typology entries, biblical institutions (cities of refuge, jubilee, year-of-release, etc.), more
> minor prophets / minor characters. The baby-names directory can be expanded with additional curated entries
> as new names are added (Asher, Benjamin, Levi, Matthew firstname-entries are queued).
