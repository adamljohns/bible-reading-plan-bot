...
<head>
    ...
    <!-- Open Graph / Twitter / SEO meta tags (auto-generated by generate_dict_entries.py) -->
    <meta name="description" content="${WORD} &mdash; biblical definition, ${META_WEBSTER}Greek/Hebrew roots, and modern corruption analysis from The MOOP Dictionary.">
    <meta property="og:title" content="${WORD} &mdash; The MOOP Dictionary">
    <meta property="og:description" content="${WORD} &mdash; biblical definition, ${META_WEBSTER}Greek/Hebrew roots, and modern corruption analysis from The MOOP Dictionary.">
...
${KJV_CONTINUAL_SECTION}
    ...
    <footer>
        ...
        <p style="margin-top:6px;font-size:0.72rem;color:#666;">MOOP Dictionary <strong style="color:var(--gold);">V6.0</strong> &middot; Pastoral Lexicon Edition &middot; <a href="index.html" style="color:#666;">index</a></p>
    </footer>
    <script>
...
def render(record):
    ...
    # Leave it unset for real 1828 words (default) so genuine Webster ties stay.
    modern = bool(record.get('modern_coinage', False))
    return HTML_TEMPLATE.substitute(
        ...
        WEBSTER_HEADING='Origin &amp; Era' if modern else 'Webster 1828 Definition',
        WEBSTER_SECTION_ID='origin' if modern else 'webster',
        META_WEBSTER='' if modern else 'Webster 1828, ',
