...
CATEGORIES = [
    ...
    (
        ...
        [
            ...
            "ark-of-the-covenant", "mercy-seat-doctrine", "candlestick",
            "veil-of-the-temple", "mitre", "girdle", "urim-and-thummim",
            "breastplate-of-judgment", "ephod-doctrine", "red-heifer",
            "sword-of-the-spirit", "helmet-of-salvation", "breastplate-of-righteousness",
            "buckler", "bow-and-arrow", "yoke-doctrine", "potter-and-clay",
            "vine-doctrine", "shepherd-and-sheep", "lamb-doctrine", "lion-doctrine",
            "dove-doctrine", "balm-of-gilead", "serpent-doctrine", "raven-doctrine",
            "almond-tree",
