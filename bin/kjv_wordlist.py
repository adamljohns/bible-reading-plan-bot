...
IRREGULAR = {
    ...
    'forgave': 'forgive', 'forgiven': 'forgive', 'hungred': 'hunger',
    'clave': 'cleave', 'cleaved': 'cleave', 'strove': 'strive',
    'striven': 'strive', 'swore': 'swear', 'bade': 'bid', 'bound': 'bind',
    'bent': 'bend', 'crept': 'creep', 'dealt': 'deal', 'dwelt': 'dwell',
    'fed': 'feed', 'felt': 'feel', 'fled': 'flee', 'flew': 'fly',
    'flown': 'fly', 'ground': 'grind', 'hewed': 'hew', 'hewn': 'hew',
    'hid': 'hide', 'lent': 'lend', 'lost': 'lose', 'meant': 'mean',
    'met': 'meet', 'paid': 'pay', 'rent': 'rend', 'rose': 'rise',
    'sold': 'sell', 'sat': 'sit', 'shod': 'shoe', 'shone': 'shine',
    'shook': 'shake', 'shaken': 'shake', 'shot': 'shoot', 'slept': 'sleep',
    'slid': 'slide', 'sowed': 'sow', 'sown': 'sow', 'spent': 'spend',
    'spun': 'spin', 'stole': 'steal', 'stolen': 'steal', 'stung': 'sting',
    'swept': 'sweep', 'swam': 'swim', 'taught': 'teach', 'tore': 'tear',
    'torn': 'tear', 'trod': 'tread', 'woke': 'wake', 'wore': 'wear',
    'worn': 'wear', 'wove': 'weave', 'woven': 'weave', 'won': 'win',
    'wrung': 'wring', 'waxed': 'wax', 'girded': 'gird', 'girt': 'gird',
    'builded': 'build', 'digged': 'dig', 'holpen': 'help',
