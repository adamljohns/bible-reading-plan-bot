# Worship — YouTube curation log

Auto-picked by Claude overnight (2026-06-13/14). Each was matched by **exact title** and,
where the title was ambiguous, **verified against the lyrics in your chart** so the video is
the right song. To swap any pick: edit `docs/data/worship-overrides.json` and run
`node generate-worship-pages.js --pages`.

| Song (slug) | Artist / version chosen | YouTube ID | Why |
|---|---|---|---|
| amazing-grace | Chris Tomlin — Amazing Grace (My Chains Are Gone), official lyric | `QBRwoqJP2sk` | Most-sung modern version of the hymn |
| blessed-be-your-name | Matt Redman — official lyric | `Rw4H5t3TwHM` | Original writer |
| cornerstone | Hillsong Worship — official lyric | `Fl15U2ifYzo` | Definitive recording |
| shout-to-the-lord | Hillsong Worship — lyrics video | `0-8QGQpol2A` | Darlene Zschech / Hillsong original |
| hosanna | Hillsong Worship — official lyric | `RMRGi1fEdB0` | Verified lyrics "I see the King of glory" |
| holy-is-the-lord | Chris Tomlin — lyric video | `uInmeLDRcK8` | Original writer |
| trading-my-sorrows | Darrell Evans — official lyric | `P4t7HXcJsD4` | Original writer |
| at-the-cross | Randy/Terry Butler — "I know a place" | `8zyn17qYq5E` | **Verified** your chart is the Butler song, not Tomlin's "Love Ran Red" |
| consuming-fire | Tim Hughes — lyric video | `6XOBBUu_23M` | **Verified** "There must be more than this" |
| breathe | Michael W. Smith — "This is the air I breathe" | `lCdX5Zrsers` | **Verified** Marie Barnett song; MWS is the famous recording |
| you-are-my-all-in-all | Dennis Jernigan — lyrics (4K) | `R3G8PTjTX4c` | Original writer; "You are my strength when I am weak" |
| lord-i-lift-your-name-on-high | Rick Founds — official lyric | `scm3VFcT6no` | Original writer |
| be-glorified | Billy Funk — Integrity/Hosanna recording | `hmZzTDTkdos` | **Verified** your chart credits Billy Funk (not Tomlin's "Be Glorified") |
